// Build-Config file for FortressOne
// to use: make FTE_CONFIG=fortressone
...
//general rebranding
#define DISTRIBUTION			"FO"							//should be kept short. 8 or less letters is good, with no spaces.
#define DISTRIBUTIONLONG		"FortressOne Team"		//think of this as your company name. It isn't shown too often, so can be quite long.
#define FULLENGINENAME			"FortressOne"						//nominally user-visible name.
#define ENGINEWEBSITE			"https://www.fortressone.org"	//for shameless self-promotion purposes.
#define BRANDING_ICON			"fortressone.ico"				//The file to use in windows' resource files - for linux your game should include an icon.[png|ico] file in the game's data.

//filesystem rebranding
#define GAME_SHORTNAME			"fo"			//short alphanumeric description
...
#define GAME_PROTOCOL			"FortressOne"		//so other games won't show up in the server browser
